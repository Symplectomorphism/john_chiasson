...
\begin{longtable}{|C{0.15\linewidth}|  C{0.00\linewidth} C{0.3\linewidth} C{0.0\linewidth} C{0.4\linewidth}|}\hline	
	...
	\CT{11:00 -- 11:15}{Ruthvik Vaila}{Lamb Weston}{Remembering Dr. John Chiasson}
	\CT{11:15 -- 11:30}{Aykut Sat{\i}c{\i}}{MBE, Boise State University}{John Chiasson: An American Treasure}
	\tablebreak{11:30 a.m. -- 12:15 p.m.}{Refreshments}
	\tablebreak{12:15 p.m. -- 2:30 p.m.}{Symposium}
	\CT{12:15--12:30}{Doug Birdwell}{Univ. of Tennessee, Knoxville}{A Brief Tribute to John Chiasson}
	\CT{12:30--12:45}{Hairong Qi}{Univ. of Tennessee, Knoxville}{Found John! He's at Barnes \& Noble!}
	\CT{12:45 -- 1:00}{Leon Tolbert}{Univ. of Tennessee, Knoxville}{Spacetime PQ Theory for AC and DC Systems}
	\CT{1:00--1:15}{\.{I}nan\c{c} \c{S}enocak}{University of Pittsburgh}{Solving forward and inverse PDE problems with Physics and Equality Constrained Artificial Neural Networks}
	\CT{1:15--1:30}{Burak \"{O}zpineci}{Oak Ridge National Lab.}{Harmonic Optimization and Heat Exchanger Design using Genetic Algorithms}
	\CT{1:30--1:45}{Uri Rogers}{Eastern Washington University}{Differentially Flat Systems and Happiness}
	\CT{1:45-2:00}{Vishal Saxena}{University of Delaware}{Vishal and John's history}
	\CT{2:00-2:15}{Itamar Arel}{Morado Ventures}{John's sabbatical at Itamar's company}
	\CT{2:15-2:30}{Zachary Adams}{Pitch Aeronautics}{Zach and John's collaborations}
\end{longtable}
